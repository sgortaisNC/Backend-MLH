...
function Edit(_ref) {
  ...
  const TEMPLATE = [['core/heading', {
    placeholder: 'Saisissez ici le titre de l\'accordéon...'
  }]];
  setAttributes({
    id: context['nc-accordion/id']
  });
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save({
    ...
    "data-bs-target": `#collapse-${attributes.id}`
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"nc/accordion-heading","version":"0.1.0","title":"Titre de l\'accordéon","category":"design","icon":"editor-justify","supports":{"html":false},"textdomain":"accordion","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","attributes":{"id":{"type":"integer"}},"usesContext":["nc-accordion/id"],"parent":["nc/accordion"]}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkaccordion_heading"] = globalThis["webpackChunkaccordion_heading"] || [];
