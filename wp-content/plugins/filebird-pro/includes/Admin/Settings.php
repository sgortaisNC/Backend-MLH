...
class Settings {
	...
	public function settingsPage() {
		...
		if ( '' !== $filebird_activation_error ) {
			...
			$notice = '<div class="njt-warning-notice notice notice-warning is-dismissible"><p>' . $filebird_activation_error . '</p><button type="button" class="notice-dismiss" onClick="jQuery(\'.njt-warning-notice\').remove()"><span class="screen-reader-text">' . __( 'Dismiss this notice.', 'filebird' ) . '</span></button></div>';
		}

		echo '<div class="wrap">' . $notice . '<div id="filebird-setting"/></div>';
