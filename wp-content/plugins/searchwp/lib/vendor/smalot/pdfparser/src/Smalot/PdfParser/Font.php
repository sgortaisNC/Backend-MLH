...
class Font extends \SearchWP\Dependencies\Smalot\PdfParser\PDFObject
{
    ...
    public function translateChar($char, $use_default = \true)
    {
        ...
        if (\strlen($char) < 2 && $this->has('Encoding') && $this->get('Encoding') instanceof \SearchWP\Dependencies\Smalot\PdfParser\Encoding && \SearchWP\Dependencies\Smalot\PdfParser\Encoding\WinAnsiEncoding::class === $this->get('Encoding')->__toString()) {
